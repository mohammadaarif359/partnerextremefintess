	...
	<div class="col-12">
	  <div class="card">
		<div class="card-header">
		  <h3 class="card-title">Gym Member</h3>
		  <div class="card-tools">
			  <div class="d-flex flex-row justify-content-center">			  
				  <a href="{{ route('admin.gym-member.add',['partner_id' => $partner_id]) }}" class="btn btn-primary btn-sm ml-2">Add</a>
				  <a href="{{ route('admin.gym-member.export',['partner_id' => $partner_id]) }}" class="btn btn-primary btn-sm ml-2">Export</a>
			  </div>	
		  </div>
		</div>
		<!-- /.card-header -->
